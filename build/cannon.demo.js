...
CANNON.Demo = function(options){
    ...
    function init() {
        ...
        light.target.position.set( 60, 0, 0 );
        ...
        secondLight.shadowCameraNear = 10;
        secondLight.shadowCameraFar = 100;//camera.far;
        secondLight.shadowCameraFov = 30;

        secondLight.shadowMapBias = 0.0039;
        secondLight.shadowMapDarkness = 0.5;
        secondLight.shadowMapWidth = SHADOW_MAP_WIDTH;
        secondLight.shadowMapHeight = SHADOW_MAP_HEIGHT;

        thirdLight = new THREE.SpotLight( 0xffffff );
        thirdLight.position.set( -20, 0, 20 );
        thirdLight.target.position.set( -20, 0, 0 );

        thirdLight.castShadow = true;

        thirdLight.shadowCameraNear = 10;
        thirdLight.shadowCameraFar = 100;//camera.far;
        thirdLight.shadowCameraFov = 30;

        thirdLight.shadowMapBias = 0.0039;
        thirdLight.shadowMapDarkness = 0.5;
        thirdLight.shadowMapWidth = SHADOW_MAP_WIDTH;
        thirdLight.shadowMapHeight = SHADOW_MAP_HEIGHT;

        fourthLight = new THREE.SpotLight( 0xffffff );
        fourthLight.position.set( -60, 0, 20 );
        fourthLight.target.position.set( -60, 0, 0 );

        fourthLight.castShadow = true;

        fourthLight.shadowCameraNear = 10;
        fourthLight.shadowCameraFar = 100;//camera.far;
        fourthLight.shadowCameraFov = 30;

        fourthLight.shadowMapBias = 0.0039;
        fourthLight.shadowMapDarkness = 0.5;
        fourthLight.shadowMapWidth = SHADOW_MAP_WIDTH;
        fourthLight.shadowMapHeight = SHADOW_MAP_HEIGHT;
